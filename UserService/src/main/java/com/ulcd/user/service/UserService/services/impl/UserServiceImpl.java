...
//	
	...
	public User getUser(String userId) {
		...
		ArrayList forObject= restTemplate.getForObject("http://localhost:8083/ratings/users/09d4726f-c6d1-4749-ba62-50f8bca31361", ArrayList.class);
		logger.info("{} ",forObject);
		
		System.out.println("dddddddddddddd" + forObject);
